    ...
    return (
        <div className='analytics'>
            ...
            <BaseCard width={600} height={400}>
                ...
                {/* Pass the activeButton (timeframe) to the CombChart */}
                <CombChart timeframe={activeButton} />
            </BaseCard>

            <BaseCard width={400} height={400}>
                <p className='comp-name'>Devices Consumption</p>
                {/* Pass the activeButton (timeframe) to the CircuitsChart */}
                <CircuitsChart timeframe={activeButton} />
            </BaseCard>
        </div>
    );
};
